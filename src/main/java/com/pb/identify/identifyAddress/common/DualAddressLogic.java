...
/**
 * 
 * Enum to Indicate how to return a match if multiple non-blank address lines are present or multiple address types are on the same address line. (U.S. addresses only.)
 * 
 *
 */
public enum DualAddressLogic {
	/**
