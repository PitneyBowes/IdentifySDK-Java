...
/**
 * Sample Code for accessing CheckGlobalWatchListAsync API
 * Java SDK. To make it work, make sure to update your API KEY and SECRET before
 * running this code.
 */
public class CheckGlobalWatchListMain_Async {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		RequestObserver<CheckGlobalWatchListAPIResponseList> requestObserver = new RequestObserver<CheckGlobalWatchListAPIResponseList>() {
			@Override
			public void onSuccess(CheckGlobalWatchListAPIResponseList response) {
		...
		identifyRiskService.checkGlobalWatchListAsync(records,requestObserver);
	}
