 ...
 * running this code.
 */
public class ValidateMailingAddressUSCAN {
	...
	public static void main(String[] args) {
		...
		try {
			...
			ValidateMailingAddressUSCANAPIResponseList response = identifyAddressService.validateMailingAddressUSCAN(addresses,null);
