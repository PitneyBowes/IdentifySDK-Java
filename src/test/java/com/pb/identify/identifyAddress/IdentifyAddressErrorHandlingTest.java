 ...
 */
public class IdentifyAddressErrorHandlingTest {
	...
	public void testVaildateMailingAddressInvalidToken() throws SdkException, JSONException, IOException {
		...
		try {
			ValidateMailingAddressAPIResponseList response = identifyAddressService.validateMailingAddress(Arrays.asList(address),null);
