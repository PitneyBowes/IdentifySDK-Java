 ...
 */
public class IdentifyAddressErrorHandlingTestGetCityStateProvince {
	...
	@Test
	public void testGetCityStateProvinceInvalidToken() throws SdkException, JSONException, IOException {
		...
		try {
			GetCityStateProvinceAPIResponseList response = identifyAddressService.getCityStateProvince(Arrays.asList(record),null);
	...
	@Test
	public void testGetCityStateProvinceInvalidKey() {
		String API_KEY = "JUNK";
