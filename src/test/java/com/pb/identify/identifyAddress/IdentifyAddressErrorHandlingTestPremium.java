...
public class IdentifyAddressErrorHandlingTestPremium {
	...
	@Test
	public void testVaildateMailingAddressPremiumInvalidToken() throws SdkException, JSONException, IOException {
		TEST_TOKEN="JUNK";
		...
		try {
			ValidateMailingAddressPremiumAPIResponseList response = identifyAddressService.validateMailingAddressPremium(Arrays.asList(address),null);
	...
	@Test
	public void testValidateMailingAddressPremiumInvalidKey() {
		String API_KEY = "JUNK";
