...
import com.pb.identify.identifyAddress.validateMailingAddressPro.model.Options;
 ...
 */
public class IdentifyAddressTestPro {
	...
	private static final String VALIDATE_MAILING_ADDRESS_PRO_REQUEST_SRC = "\\src\\test\\resources\\validateMailingAddressProRequest.json";
	private static final String VALIDATE_MAILING_ADDRESS_PRO_BATCH_REQUEST_SRC = "\\src\\test\\resources\\validateMailingAddressProBatchRequest.json";
	...
	private List<Address> buildDummyAddressesPro(){
	...
	private static RequestObserver validateMailingAddressProCallBack(final List<ValidateMailingAddressProAPIResponse> responses,
			final SdkException[] sdkException) {
		return new RequestObserver<ValidateMailingAddressProAPIResponseList>() {
			@Override
			public void onSuccess(ValidateMailingAddressProAPIResponseList responseList) {
	...
	@Test
	public void testWhetherSDKAndAPIResponsesMatchForValidateMailingAddressPro() throws SdkException, JSONException, IOException {

		String jsonResponseFromAPI = TestUtility.getJSONResponseFromApiForPOSTRequest(VALIDATE_MAILING_ADDRESS_PRO_REQUEST_SRC, TEST_URL,
				"/identifyaddress/v1/rest/validatemailingaddresspro/results.json");
		Options options = new Options();
		...
		ValidateMailingAddressProAPIResponseList response = identifyAddressService.validateMailingAddressPro(Arrays.asList(address),options);
	...
	@Test
	public void testWhetherSDKAndAPIResponsesMatchForValidateMailingAddressProAsync()
		...
		final ValidateMailingAddressProAPIResponseList validateMailingAddressProResponse = new ValidateMailingAddressProAPIResponseList();
		identifyAddressService.validateMailingAddressProAsync(Arrays.asList(address),options,validateMailingAddressProCallBack(validateMailingAddressProResponse.getResponses(), null));

		Thread.sleep(5000);

		Gson gson = new GsonBuilder().create();
		String jsonResponseFromSDK = gson.toJson(validateMailingAddressProResponse);
		JSONAssert.assertEquals(jsonResponseFromAPI, jsonResponseFromSDK, JSONCompareMode.STRICT);

	}

	@Test
	public void testWhetherSDKAndAPIResponsesMatchForValidateMailingAddressProBatch() throws SdkException, JSONException, IOException {

		String jsonResponseFromAPI = TestUtility.getJSONResponseFromApiForPOSTRequest(VALIDATE_MAILING_ADDRESS_PRO_BATCH_REQUEST_SRC,
				TEST_URL, "/identifyaddress/v1/rest/validatemailingaddresspro/results.json");
		ValidateMailingAddressProAPIResponseList response = identifyAddressService.validateMailingAddressPro(buildDummyAddressesPro(), null);
		Gson gson = new GsonBuilder().create();
		String jsonResponseFromSDK = gson.toJson(response);
		JSONAssert.assertEquals(jsonResponseFromAPI, jsonResponseFromSDK, JSONCompareMode.STRICT);
	...
	@Test
	public void testWhetherSDKAndAPIResponsesMatchForValidateMailingAddressProBatchAsync()
			throws SdkException, JSONException, IOException, InterruptedException {
		...
		Options options = new Options();
		final ValidateMailingAddressProAPIResponseList validateMailingAddressProResponse = new ValidateMailingAddressProAPIResponseList();
		identifyAddressService.validateMailingAddressProAsync(buildDummyAddressesPro(),options,validateMailingAddressProCallBack(validateMailingAddressProResponse.getResponses(), null));
